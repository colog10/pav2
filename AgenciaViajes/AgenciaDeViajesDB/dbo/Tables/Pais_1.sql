CREATE TABLE [dbo].[Pais] (
    [idPais]                      NVARCHAR (3) CONSTRAINT [DF__Pais__PaisCodigo__778AC167] DEFAULT ('') NOT NULL,
    ...
    [idPais2]                     CHAR (2)     CONSTRAINT [DF__Pais__PaisCodigo__04E4BC85] DEFAULT ('') NULL,
    CONSTRAINT [PK__Pais__F3A7B39A75A278F5] PRIMARY KEY CLUSTERED ([idPais] ASC)
);
